    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <a class="navbar-brand" href="<?php echo BASE_URL; ?>./index.php"><img class="headerlogo" src="<?php echo BASE_URL; ?>./public/images/logo2.png" alt="logo"
                        style="width:80px;"></a>
                <form class="d-flex">
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/public_html/informacio-partnereknek.php">Információ partnereknek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/public_html/kapcsolat.php">Kapcsolat</a>
                    </li>
                </ul>
            </div>
        </div>
