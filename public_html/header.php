        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/informacio-partnereknek.php">Információ partnereknek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/kapcsolat.php">Kapcsolat</a>
                    </li>
                </ul>
            </div>
        </div>
